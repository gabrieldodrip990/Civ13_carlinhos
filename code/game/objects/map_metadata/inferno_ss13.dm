...
//Vai se fuder caveirinha e o gabriel é um gostoso
//cachorro11 da a bunda no matagal e para a panela, 2050 homens da panela diferente comerão e cagarão no cachorro11, cachorro11 é um arrombado, cachorro11 é o mais estuprado do mundo 
/obj/map_metadata/ss13warfare
	...
	mission_start_message = "<font size=4>Todas as fac��es tem vending de armas e muni��o, se preparem e acabe com os Slots do Inimigo!"
	faction1 = GERMAN
	faction2 = RUSSIAN
...
/obj/structure/vending/ss13war
	...
	desc = "Vending de armas, todas de gra�a."
...
/obj/structure/vending/ss13war_ammo
	name = "Muni��o"
	desc = "Vending de muni��o, todas de gra�a."
	icon_state = "equipment_russia"
	products = list(
